...
public class Connect2 {
	public static void main(String[] args) {
		...
		System.out.println("Player red, choose your name.");
		String playerrname=scan.nextLine();
		System.out.println("Player yellow, choose your name.");
		String playeryname=scan.nextLine();
